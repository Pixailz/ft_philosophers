...
/*   Updated: 2022/08/17 00:15:48 by brda-sil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	error_init(int return_code)
{
	...
	if (return_code >= 1 && return_code <= 4)
		ft_putstr_strderr("malloc");
	else if (return_code >= 5)
		ft_putstr_strderr("init mutex");
	if (return_code == 1)
		ft_putstr_strderr("(**philos)\n");
	if (return_code == 2)
		ft_putstr_strderr("(*philo)\n");
	if (return_code == 3)
		ft_putstr_strderr("(**forks)\n");
	if (return_code == 4 || return_code == 5)
		ft_putstr_strderr("(*fork)\n");
	if (return_code == 6)
		ft_putstr_strderr("(m_speak)\n");
	if (return_code == 7)
		ft_putstr_strderr("(m_have_died)\n");
	if (return_code == 8)
		ft_putstr_strderr("(m_last_meal)\n");
	if (return_code == 10)
		ft_putstr_strderr("(m_nb_eat)\n");
